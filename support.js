...
(() => {
  ...
  var BASE_CSS = `
    ...
    html.sc-dc-streaming .sc-interp.sc-missing::before{content:'';
      ...
      background:linear-gradient(90deg,rgba(107,16,37,0) 25%,rgba(246,240,230,.95) 37%,rgba(107,16,37,0) 63%);
    ...
    .sc-interp.sc-missing{display:inline-block;width:2em;height:1em;overflow:hidden;
      vertical-align:text-bottom;background:rgba(246,240,230,.3);border:1px solid rgba(107,16,37,.5);
    ...
    .sc-logic-error{position:absolute;top:8px;left:8px;z-index:2147483647;max-width:60ch;
      padding:6px 10px;background:#6B1025;color:#F6F0E6;font:12px/1.4 ui-monospace,monospace;
  ...
  var CANVAS_BG_LIGHT = "#F6F0E6";
  var CANVAS_BG_DARK = "#6B1025";
